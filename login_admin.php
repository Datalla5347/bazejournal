...
if( isset($_POST['action']) AND isset($_POST['action']) == 'admin-login'){
    ...
    if( $dbc->affected_rows > 0 ){
      ...
      $_SESSION['loggedInEditorId'] = $admin['id'];
   ...
   <div class="footer">
      <div class="container">
        ...
        <div class="row">
          <div class="col-12">
            <div class="copyright">
                <p>Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This website is made <i class="icon-heart" aria-hidden="true"></i> by Datalla Muhammad Wade-Wade</a></p>
            </div>
          </div>
        </div>
